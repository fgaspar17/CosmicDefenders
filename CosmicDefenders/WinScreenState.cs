...
internal class WinScreenState : IGameState
{
    Font _font;
    ...
    public WinScreenState(int windowWidth)
    {
    ...
    {
        _gameOverText = new Text("WIN", _font, 40);
        _gameOverText.FillColor = Color.Green;
        long x = width / 2;
    ...
    public int GetState()
    {
        return _nextScreen ? States.TITLE_SCREEN : States.WIN_SCREEN;
    }
